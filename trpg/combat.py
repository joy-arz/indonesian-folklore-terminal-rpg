...
class Enemy:
    ENEMY_TEMPLATES = [
        ...
        {"name": "Ahool", "hp": 18, "attack": 7, "defense": 1, "gold": (5, 12), "xp": 35, "level": 4},
        {"name": "Orang Bati", "hp": 22, "attack": 8, "defense": 2, "gold": (8, 18), "xp": 45, "level": 5},
        {"name": "Naga Besukih", "hp": 45, "attack": 14, "defense": 6, "gold": (50, 100), "xp": 120, "level": 12},
        {"name": "Suku Mante", "hp": 8, "attack": 4, "defense": 1, "gold": (3, 8), "xp": 20, "level": 2},
        {"name": "Kuda Sembrani", "hp": 28, "attack": 9, "defense": 3, "gold": (20, 40), "xp": 65, "level": 6},
        {"name": "Kuyang", "hp": 20, "attack": 9, "defense": 2, "gold": (10, 25), "xp": 50, "level": 5},
        {"name": "Nyi Blorong", "hp": 32, "attack": 11, "defense": 4, "gold": (35, 70), "xp": 90, "level": 9},
    ]

    DROP_TABLE = {
        "common": ["nasi bungkus", "buah-buahan", "keris kecil", "baju zirah"],
        "uncommon": ["jamu kuat", "tombak", "perisai besi", "gelang emas"],
        "rare": ["jamu sakti", "pedang naga", "baju besi", "cincin sakti"],
        "legendary": ["keris pusaka", "pedang lengkung", "baju perang", "kalung keramat"],
    }
